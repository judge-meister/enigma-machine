...
def test2():
    rotors=[('AJDKSIRUXBLHWTMCQGZNPYFVOE', 'F', 'E'),
            ('EKMFLGDQVZNTOWYHXUSPAIBRCJ', 'R', 'O'),
            ('ESOVPZJAYQUIRHXLNFTGKDCMWB', 'K', 'E')]
    reflector = 'YRUHQSLDPXNGOKMIEBFZCWVJAT'
    plug_board = [('E', 'X'), ('F', 'B'), ('H', 'P'), ('L', 'J'), ('M', 'S'), ('Q', 'T'), ('R', 'O'), ('U', 'G'), ('Y', 'C'), ('Z', 'I')]
...
if __name__ == '__main__':
    ...
    enc = machine.encrypt("ABC")
    print enc
    
    machine2=test2()
    
    print machine2.encrypt(enc)